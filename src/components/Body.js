...
//   ) : ( 
//     <>
//       <div className="flex items-center justify-between mx-6 mt-1 w-full md:w-3/10 md:mr-4">
//         <div className="flex justify-between border border-gray-300 p-2 my-2 rounded-lg w-3/10">
//           <input
//             type="text"
//             className="outline-0 p-1 m-0 5"
...
//       <div className="restraunt-list  display: flex;
//   flex-wrap: wrap;
//   align-items: center;
...
//           return (
//             <Link
//               className="restraunt-link w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-2 m-2 box-content transition-transform duration-300 text-black no-underline"
